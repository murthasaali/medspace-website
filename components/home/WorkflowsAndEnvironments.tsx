...
const useCases = [
  {
    ...
    description: "Eliminate 2+ hours of daily charting by converting bedside dialogue into structured SOAP notes and ICD-10 codes.",
  ...
  },
  {
    ...
    description: "Stream cellular vitals directly to clinician dashboards with automatic CPT 99453/54 reimbursement qualification.",
  ...
  },
  {
    ...
    badge: "AUTOMATION",
    description: "Streamline patient intake, AI-driven reminder cadences, and reduce clinic no-shows by up to 45%.",
  ...
  },
  {
    ...
    description: "Deliver 6th-grade reading level health summaries, personalized care reminders, and clear medication instructions.",
  ...
  },
  {
    ...
    description: "Run longitudinal cohort queries across de-identified institutional graphs with guaranteed k-anonymity (k=25).",
  ...
  },
  {
    ...
    description: "Unify fragmented hospital department silos into a sovereign on-premise knowledge layer with zero cloud data egress.",
    href: "/products/clinicalkg-enterprise",
...
const personas = [
  ...
  },
  {
    ...
    icon: "corporate_fare",
    description: "Deploy air-gapped on-premise sovereign nodes that satisfy the most stringent HIPAA and ONC criteria.",
