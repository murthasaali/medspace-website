export default function FinalCTA() {
  return (
    <section className="w-full pb-24 px-6 lg:px-12 max-w-7xl mx-auto" id="demo">
      <div className="bg-surface-matcha/50 rounded-3xl p-8 lg:p-16 relative overflow-hidden shadow-sm">
        ...
        <div className="max-w-2xl relative z-10">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant mb-8">
            Join medical groups and innovative clinics reclaiming 2+ hours daily, eliminating billing leaks, and guaranteeing complete data sovereignty.
          </p>
          <div className="flex flex-wrap items-center gap-4 mb-10">
            <a className="inline-flex items-center justify-center h-14 px-8 rounded-full bg-forest-deep text-on-primary font-label-lg text-label-lg hover:bg-primary transition-all shadow-md gap-2 group" href="#">
              <span>Book an Executive Consultation</span>
              <span className="transition-transform group-hover:translate-x-1">&rarr;</span>
            </a>
            <a className="inline-flex items-center justify-center h-14 px-8 rounded-full bg-surface-cream text-forest-deep font-label-lg text-label-lg hover:bg-surface-container transition-colors shadow-sm" href="#graph-inspector">
              <span>Test Query Inspector</span>
            </a>
          </div>
