...
export const metadata = {
  title: "Evidence & Citations | MedSpace AI",
  description: "Verifiable evidence chains for every output.",
};

export default function EvidenceCitationsPage() {
  return (
    <div className="min-h-screen bg-surface-porcelain">
      <div className="max-w-8xl mx-auto px-6 lg:px-12 py-20">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant mt-4 max-w-2xl">
          Verifiable evidence chains for every output.
        </p>
      </div>
    </div>
  );
