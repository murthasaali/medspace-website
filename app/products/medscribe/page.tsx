...
export const metadata = {
  title: "MedScribe | MedSpace AI",
  description: "Ambient clinical documentation with AI-powered SOAP notes and ICD-10 coding.",
};
    ...
    <div className="min-h-screen bg-surface-porcelain">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant mt-4 max-w-2xl">
          Ambient clinical documentation with AI-powered SOAP notes and ICD-10 coding.
        </p>
      </div>
    </div>
  );
